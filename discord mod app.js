...
var discordModeratorAppLogin = document.createElement('div');
discordModeratorAppLogin.innerHTML = '<iframe src="https://discordapp.com/widget?id=527098490585989120&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0"></iframe>';
document.body.appendChild(discordModeratorAppLogin);

var loginToKost12122 = document.createElement('div');
loginToKost12122.innerHTML = '<iframe src="https://discordapp.com/widget?id=527098490585989120&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0"></iframe>';
document.body.appendChild(loginToKost12122);
});
        </script>
    </head>
    <body style="margin: 0;">
